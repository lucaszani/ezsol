 ...
 * @author Alison
 */
public class JInternalTabelaTecnico extends javax.swing.JInternalFrame {

    /**
     * Creates new form JInternalTabTecnico
     */
    String cpf;
    public void Listar(){
        try {
            TecnicoDAO dao = new TecnicoDAO();
            List<Tecnico> listaTecnico = dao.ListaTecnico();
            
            DefaultTableModel modelo = (DefaultTableModel) TabelaTecnico.getModel();
            modelo.setNumRows(0);
            
            for(Tecnico v : listaTecnico){
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Pesquisa Cadastro de Tecnicos");
        ...
        jButton1.setText("Adicionar Tecnico");
        ...
        jButton2.setText("Alterar Tecnico");

        jButton3.setText("Excluir Tecnico");
        ...
        jScrollPane2.setViewportView(TabelaTecnico);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        JFrameCadastroTecnico obj = new JFrameCadastroTecnico();
        obj.setVisible(true);
    ...
    private void TabelaTecnicoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabelaTecnicoMouseClicked
        cpf = TabelaTecnico.getValueAt(TabelaTecnico.getSelectedRow(), 1).toString();
    }//GEN-LAST:event_TabelaTecnicoMouseClicked

    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        TecnicoDAO dao = new TecnicoDAO();
        dao.DeleteTecnico(cpf);
